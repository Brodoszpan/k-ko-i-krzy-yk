       ...
       public void button2_Click(object sender, EventArgs e)
        {
           ...
           string[] kolorki = new string[7] { "ScrollBar", "DarkGray","PaleGoldenrod", "GreenYellow", "Aqua", "Gainsboro", "Olive" };

            Random losowe_kolorki = new Random();
            int loosowe = losowe_kolorki.Next(0, 6);
        ...
        private void lbl_ruch_Click(object sender, EventArgs e)
        {
        ...
        private void bttn1_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show(text, "ZASADY", MessageBoxButtons.OK);
